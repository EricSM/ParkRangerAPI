...
def main():
    test_area = Area("Test Area", 5780993)
    test_area.add_rule('temp', 10000, 'leq', "A test rule that is triggered if temp <= 10000") # Becomes if(temp <= 10000)
    test_area_weather = test_area.get_weather()

    triggered_rules = test_area.check_rules(test_area_weather)
